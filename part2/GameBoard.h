...
struct GameBoard {
    ...
    constexpr static int width = T::head::size; /// The width is the number of columns, which is the number of elements in each list.
    constexpr static int length = T::size; /// The length is the number of rows, which is the number of lists.
};
